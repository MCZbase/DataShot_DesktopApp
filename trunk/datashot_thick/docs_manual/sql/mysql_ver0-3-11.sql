...
CREATE TABLE `Image` (
  ...
  CONSTRAINT `Image_ibfk_1` FOREIGN KEY (`SpecimenId`) REFERENCES `Specimen` (`SpecimenId`)
...
) ENGINE=MyISAM AUTO_INCREMENT=108129 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=154239 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `UNIT_TRAY_LABEL` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3507 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-06-01 12:52:40
